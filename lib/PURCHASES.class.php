...
*/
    ...
    public function getPurchaseDocumentInfo($id)
    {
        $result = $this->db->GetRow(
            ...
            pds.cdate, to_char(TO_TIMESTAMP(pds.cdate) AT TIME ZONE \'CEST\', \'YYYY/MM/DD\') AS cdate_formatted,
            pds.sdate, to_char(TO_TIMESTAMP(pds.sdate) AT TIME ZONE \'CEST\', \'YYYY/MM/DD\') AS sdate_formatted,
            pds.deadline, to_char(TO_TIMESTAMP(pds.deadline) AT TIME ZONE \'CEST\', \'YYYY/MM/DD\')  AS deadline_formatted,
            pds.paydate, to_char(TO_TIMESTAMP(pds.paydate) AT TIME ZONE \'CEST\', \'YYYY/MM/DD\') AS paydate_formatted,
